...
\033[1;37m
\033[1;31m---------------------------------------
\033[1;35mCREATED BY : \033[33mkazi samir
\033[1;35mGITHUB     : \033[1;33mgithub.com/kaķisamir4
\033[1;35mFACEBOOK   : \033[1;33mFOURKANUDDIN123
...
def sms_bombing():
    ...
    for sms in range(limit):
        ...
        print "\033[1;31m--------------------------"
        if sms_limit == limit:
           os.system('xdg-open https://m.facebook.com/FOURKANUDDIN123')
def intro():
    os.system('clear')
    print logo
    print ""
